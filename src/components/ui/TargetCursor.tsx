...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  return (
    <div
      ref={cursorRef}
      className="pointer-events-none fixed inset-s-0 top-0 z-9999 h-0 w-0"
      style={{ willChange: "transform" }}
    >
      <div
        ref={dotRef}
        className="absolute inset-s-1/2 top-1/2 h-1 w-1 -translate-x-1/2 -translate-y-1/2 rounded-full rtl:translate-x-1/2"
        style={{ willChange: "transform", backgroundColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute inset-s-1/2 top-1/2 h-3 w-3 translate-x-[-150%] translate-y-[-150%] border-[3px] border-e-0 border-b-0 rtl:translate-x-[150%]"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute inset-s-1/2 top-1/2 h-3 w-3 translate-x-1/2 translate-y-[-150%] border-[3px] border-s-0 border-b-0 rtl:-translate-x-1/2"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute inset-s-1/2 top-1/2 h-3 w-3 translate-x-1/2 translate-y-1/2 border-[3px] border-s-0 border-t-0 rtl:-translate-x-1/2"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute inset-s-1/2 top-1/2 h-3 w-3 translate-x-[-150%] translate-y-1/2 border-[3px] border-e-0 border-t-0 rtl:translate-x-[150%]"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
    </div>
  )
